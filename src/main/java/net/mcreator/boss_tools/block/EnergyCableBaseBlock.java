...
public class EnergyCableBaseBlock extends BossToolsModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("energy_cable_base"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Energy Cable Base");
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(10, 200, 200, 0) {
			@Override
