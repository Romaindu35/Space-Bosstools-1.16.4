	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case SOUTH :
				default :
					return VoxelShapes.create(1D, 0D, 1D, 0D, 0.125D, 0D).withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.create(0D, 0D, 0D, 1D, 0.125D, 1D).withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.create(0D, 0D, 1D, 1D, 0.125D, 0D).withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.create(1D, 0D, 0D, 0D, 0.125D, 1D).withOffset(offset.x, offset.y, offset.z);
			}
		}
